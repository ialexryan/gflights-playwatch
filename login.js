...
(async () => {
  ...
  await page.goto('https://www.google.com/travel/flights/saves', { waitUntil: 'domcontentloaded' });
  console.log('> 1) Log in to Google (if prompted)');
  console.log('> 2) Ensure the Saved Flights list renders (scroll once if needed)');
